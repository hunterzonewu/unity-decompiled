...
// Type: UnityEditor.UI.SliderEditor
      ...
      if (this.m_FillRect.objectReferenceValue != (Object) null || this.m_HandleRect.objectReferenceValue != (Object) null)
      {
        ...
        if (EditorGUI.EndChangeCheck())
        {
          ...
          foreach (Object targetObject in this.serializedObject.targetObjects)
            (targetObject as Slider).SetDirection(enumValueIndex, true);
        }
        ...
        foreach (Object targetObject in this.serializedObject.targetObjects)
        {
          Slider slider = targetObject as Slider;
          switch (slider.direction)
          {
            case Slider.Direction.LeftToRight:
            case Slider.Direction.RightToLeft:
              flag = slider.navigation.mode != Navigation.Mode.Automatic && ((Object) slider.FindSelectableOnLeft() != (Object) null || (Object) slider.FindSelectableOnRight() != (Object) null);
              break;
            default:
              flag = slider.navigation.mode != Navigation.Mode.Automatic && ((Object) slider.FindSelectableOnDown() != (Object) null || (Object) slider.FindSelectableOnUp() != (Object) null);
              break;
          }
        }
        if (flag)
