...
// Type: UnityEditor.LightmapParametersEditor
...
namespace UnityEditor
{
  ...
  internal class LightmapParametersEditor : Editor
  {
    ...
    {
      this.m_Resolution = this.serializedObject.FindProperty("resolution");
      this.m_ClusterResolution = this.serializedObject.FindProperty("clusterResolution");
      this.m_IrradianceBudget = this.serializedObject.FindProperty("irradianceBudget");
      this.m_IrradianceQuality = this.serializedObject.FindProperty("irradianceQuality");
      this.m_BackFaceTolerance = this.serializedObject.FindProperty("backFaceTolerance");
      this.m_ModellingTolerance = this.serializedObject.FindProperty("modellingTolerance");
      this.m_EdgeStitching = this.serializedObject.FindProperty("edgeStitching");
      this.m_IsTransparent = this.serializedObject.FindProperty("isTransparent");
      this.m_SystemTag = this.serializedObject.FindProperty("systemTag");
      this.m_AOQuality = this.serializedObject.FindProperty("AOQuality");
      this.m_AOAntiAliasingSamples = this.serializedObject.FindProperty("AOAntiAliasingSamples");
      this.m_BlurRadius = this.serializedObject.FindProperty("blurRadius");
      this.m_AntiAliasingSamples = this.serializedObject.FindProperty("antiAliasingSamples");
      this.m_DirectLightQuality = this.serializedObject.FindProperty("directLightQuality");
      this.m_BakedLightmapTag = this.serializedObject.FindProperty("bakedLightmapTag");
      this.m_Pushoff = this.serializedObject.FindProperty("pushoff");
    }
    ...
    public override void OnInspectorGUI()
    {
      ...
      EditorGUILayout.Slider(this.m_BackFaceTolerance, 0.0f, 1f, LightmapParametersEditor.Styles.backFaceToleranceContent, new GUILayoutOption[0]);
      EditorGUILayout.Slider(this.m_ModellingTolerance, 0.0f, 1f, LightmapParametersEditor.Styles.modellingToleranceContent, new GUILayoutOption[0]);
      ...
      EditorGUILayout.Slider(this.m_Pushoff, 0.0f, 1f, LightmapParametersEditor.Styles.pushoffContent, new GUILayoutOption[0]);
      EditorGUILayout.Space();
