...
namespace UnityEditor
{
  ...
  {
    public static extern bool resetAllAudioClipPlayCountsOnPlay { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] set; }

    public static extern bool canUseSpatializerEffect { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; }
    ...
    {
      Vector3 vector3;
      AudioUtil.INTERNAL_CALL_GetListenerPos(out vector3);
      return vector3;
    }
