...
// Type: UnityEditor.DoubleCurvePresetLibrary
...
namespace UnityEditor
{
  internal class DoubleCurvePresetLibrary : PresetLibrary
  {
    ...
    private readonly Rect kUnsignedRange = new Rect(0.0f, 0.0f, 1f, 1f);
    private readonly Rect kSignedRange = new Rect(0.0f, -1f, 1f, 2f);
    ...
    {
      return (object) this.m_Presets[index].doubleCurve;
    }
    ...
    public override void Add(object presetObject, string presetName)
    {
      ...
      if (doubleCurvePreset == null)
        Debug.LogError((object) "Wrong type used in DoubleCurvePresetLibrary: Should be a DoubleCurve");
      else
        this.m_Presets.Add(new DoubleCurvePresetLibrary.DoubleCurvePreset(doubleCurvePreset, presetName));
    }
    ...
    public override void Replace(int index, object newPresetObject)
    {
      ...
      if (doubleCurve == null)
        Debug.LogError((object) "Wrong type used in DoubleCurvePresetLibrary");
      else
