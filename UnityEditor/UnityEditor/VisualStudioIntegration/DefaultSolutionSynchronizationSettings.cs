...
namespace UnityEditor.VisualStudioIntegration
{
  internal class DefaultSolutionSynchronizationSettings : ISolutionSynchronizationSettings
  {
    ...
    public virtual string SolutionTemplate
    {
      get
      {
        return string.Join("\r\n", new string[18]{ "Microsoft Visual Studio Solution File, Format Version {0}", "# Visual Studio 2008", string.Empty, "{1}", "Global", "    GlobalSection(SolutionConfigurationPlatforms) = preSolution", "        Debug|Any CPU = Debug|Any CPU", "        Release|Any CPU = Release|Any CPU", "    EndGlobalSection", "    GlobalSection(ProjectConfigurationPlatforms) = postSolution", "{2}", "    EndGlobalSection", "    GlobalSection(SolutionProperties) = preSolution", "        HideSolutionNode = FALSE", "    EndGlobalSection", "{3}", "EndGlobal", string.Empty }).Replace("    ", "\t");
      }
    }
