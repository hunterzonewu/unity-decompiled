...
namespace UnityEngine.Networking.Match
{
  ...
  public class JoinMatchRequest : Request
  {
    ...
    {
      return UnityString.Format("[{0}]-networkId:0x{1},HasPassword:{2}", (object) base.ToString(), (object) this.networkId.ToString("X"), (object) (!(this.password == string.Empty) ? "YES" : "NO"));
    }
