...
namespace UnityEngine.Networking.Match
{
  ...
  public class CreateMatchRequest : Request
  {
    ...
    {
      return UnityString.Format("[{0}]-name:{1},size:{2},advertise:{3},HasPassword:{4},matchAttributes.Count:{5}", (object) base.ToString(), (object) this.name, (object) this.size, (object) this.advertise, (object) (!(this.password == string.Empty) ? "YES" : "NO"), (object) (this.matchAttributes != null ? this.matchAttributes.Count : 0));
    }
