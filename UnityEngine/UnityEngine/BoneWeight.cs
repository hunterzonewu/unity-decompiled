  ...
  public struct BoneWeight
  {
    ...
    public static bool operator ==(BoneWeight lhs, BoneWeight rhs)
    {
      if (lhs.boneIndex0 == rhs.boneIndex0 && lhs.boneIndex1 == rhs.boneIndex1 && (lhs.boneIndex2 == rhs.boneIndex2 && lhs.boneIndex3 == rhs.boneIndex3))
        return new Vector4(lhs.weight0, lhs.weight1, lhs.weight2, lhs.weight3) == new Vector4(rhs.weight0, rhs.weight1, rhs.weight2, rhs.weight3);
      return false;
    }
    ...
    public override bool Equals(object other)
    {
      ...
      if (this.boneIndex0.Equals(boneWeight.boneIndex0) && this.boneIndex1.Equals(boneWeight.boneIndex1) && (this.boneIndex2.Equals(boneWeight.boneIndex2) && this.boneIndex3.Equals(boneWeight.boneIndex3)))
        return new Vector4(this.weight0, this.weight1, this.weight2, this.weight3).Equals((object) new Vector4(boneWeight.weight0, boneWeight.weight1, boneWeight.weight2, boneWeight.weight3));
      return false;
    }
  }
}
