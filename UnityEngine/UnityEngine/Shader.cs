...
namespace UnityEngine
{
  ...
  public sealed class Shader : Object
  {
    ...
    /// </summary>
    public bool isSupported { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; }

    internal string customEditor { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; }

    /// <summary>
    ///   <para>Shader LOD level for this shader.</para>
    /// </summary>
    public int maximumLOD { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] set; }
    ...
    /// </summary>
    public int renderQueue { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; }

    internal DisableBatchingType disableBatching { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; }
    ...
    {
      Shader.SetGlobalColor(propertyName, (Color) vec);
    }
    ...
    {
      Shader.SetGlobalColor(nameID, (Color) vec);
    }
