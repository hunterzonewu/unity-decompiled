...
namespace UnityEngine
{
  ...
  public sealed class GUISkin : ScriptableObject
  {
    ...
    public Font font
    {
      ...
      {
        this.m_Font = value;
        if ((Object) GUISkin.current == (Object) this)
    ...
    internal void Apply()
    {
      if (this.m_CustomStyles == null)
        Debug.Log((object) "custom styles is null");
    ...
    private void BuildStyleCache()
    {
      ...
      this.m_Styles = new Dictionary<string, GUIStyle>((IEqualityComparer<string>) StringComparer.OrdinalIgnoreCase);
      ...
      if (this.m_CustomStyles != null)
      {
        for (int index = 0; index < this.m_CustomStyles.Length; ++index)
        {
          if (this.m_CustomStyles[index] != null)
            this.m_Styles[this.m_CustomStyles[index].name] = this.m_CustomStyles[index];
        }
      }
    ...
    public GUIStyle GetStyle(string styleName)
    {
      ...
      if (style != null)
        return style;
      Debug.LogWarning((object) ("Unable to find style '" + styleName + "' in skin '" + this.name + "' " + (object) Event.current.type));
    ...
    public GUIStyle FindStyle(string styleName)
    {
      ...
      {
        Debug.LogError((object) "GUISkin is NULL");
    ...
    public IEnumerator GetEnumerator()
    {
      if (this.m_Styles == null)
        this.BuildStyleCache();
      return (IEnumerator) this.m_Styles.Values.GetEnumerator();
    }
