...
namespace UnityEngine
{
  ...
  public struct UIVertex
  {
    ...
    /// </summary>
    public static UIVertex simpleVert = new UIVertex() { position = Vector3.zero, normal = Vector3.back, tangent = UIVertex.s_DefaultTangent, color = UIVertex.s_DefaultColor, uv0 = Vector2.zero, uv1 = Vector2.zero };
    /// <summary>
