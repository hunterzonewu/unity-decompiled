...
namespace UnityEngine.Rendering
{
  ...
  public sealed class CommandBuffer : IDisposable
  {
    ...
    /// </summary>
    public int sizeInBytes { [WrapperlessIcall, MethodImpl(MethodImplOptions.InternalCall)] get; }
    ...
    {
      this.Blit_Texture(source, ref dest, (Material) null, -1);
    }
    ...
    {
      this.Blit_Identifier(ref source, ref dest, (Material) null, -1);
    }
    ...
    [WrapperlessIcall]
    [MethodImpl(MethodImplOptions.InternalCall)]
    private void Blit_Identifier(ref RenderTargetIdentifier source, ref RenderTargetIdentifier dest, [DefaultValue("null")] Material mat, [DefaultValue("-1")] int pass);
