...
namespace UnityEngine
{
  ...
  public struct CharacterInfo
  {
    ...
    public int glyphHeight
    {
      get
      {
        return (int) -(double) this.vert.height;
      }
      set
      {
        float height = this.vert.height;
        this.vert.height = (float) -value;
    ...
    public int minY
    {
      get
      {
        return (int) ((double) this.vert.y + (double) this.vert.height);
      }
      set
      {
    ...
    public int maxX
    {
      get
      {
        return (int) ((double) this.vert.x + (double) this.vert.width);
      }
      set
      {
    ...
    internal Vector2 uvBottomLeftUnFlipped
    {
      ...
      set
      {
        Vector2 topRightUnFlipped = this.uvTopRightUnFlipped;
        this.uv.x = value.x;
        this.uv.y = value.y;
        this.uv.width = topRightUnFlipped.x - this.uv.x;
        this.uv.height = topRightUnFlipped.y - this.uv.y;
      }
    }
    ...
    public Vector2 uvBottomRight
    {
      ...
      {
        if (this.flipped)
          return this.uvTopLeftUnFlipped;
        return this.uvBottomRightUnFlipped;
      }
      set
      {
        if (this.flipped)
