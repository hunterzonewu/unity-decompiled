...
namespace UnityEngine
{
  ...
  public class GUILayout
  {
    ...
    public static int Toolbar(int selected, GUIContent[] contents, GUIStyle style, params GUILayoutOption[] options)
    {
      ...
      vector2_1.x = vector2_1.x * (float) contents.Length + (float) left;
      return GUI.Toolbar(GUILayoutUtility.GetRect(vector2_1.x, vector2_1.y, style, options), selected, contents, style);
    }
