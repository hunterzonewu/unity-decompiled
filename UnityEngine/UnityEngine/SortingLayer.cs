...
namespace UnityEngine
{
  ...
  public struct SortingLayer
  {
    ...
    public static SortingLayer[] layers
    {
      get
      {
        int[] layerIdsInternal = SortingLayer.GetSortingLayerIDsInternal();
        SortingLayer[] sortingLayerArray = new SortingLayer[layerIdsInternal.Length];
        for (int index = 0; index < layerIdsInternal.Length; ++index)
          sortingLayerArray[index].m_Id = layerIdsInternal[index];
        return sortingLayerArray;
      }
    }
